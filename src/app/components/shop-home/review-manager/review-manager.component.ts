...
export class ReviewManagerComponent implements OnInit{  reviews: any[] = [];
  searchTerm: string = '';
  ...
  constructor(private reviewService: ReviewService, private toastr: ToastrService,public util: Util,  private modalService: NgbModal,){}
